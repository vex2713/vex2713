...
task usercontrol()
{
	...
	while (true)
	{
		...
		if( vexRT[Ch4] == 0)
		{
			...
			motor[port3] = iport3;							// Remove these as well and replace with your appropriate code
			motor[port2] = iport2;              // Remove these as well and replace with your appropriate code
			motor[port9] = iCh29;
			motor[port8] = iCh28;
