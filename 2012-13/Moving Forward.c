#pragma config(Motor,  port1,           FrontLeftMotor, tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port3,           BackLeftMotor, tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port4,           BackRightMotor, tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port10,          FrontRightMotor, tmotorVex393, openLoop, reversed)
...
task main()
{
	...
	motor[BackRightMotor] = 127;		  // Motor on port2 is run at full (127) power forward
	motor[BackLeftMotor]  = 127;		  // Motor on port3 is run at full (127) power forward
