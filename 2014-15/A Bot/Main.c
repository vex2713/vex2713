#pragma config(Motor,  port1,           LeftMotorFront, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port2,           RightMotorFront, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port3,           LeftMotorBack, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port4,           RightMotorBack, tmotorVex393_MC29, openLoop)
