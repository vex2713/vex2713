...
#pragma config(Motor,  port5,           armLift,       tmotorVex269_MC29, openLoop)
#pragma config(Motor,  port6,           armWrist,      tmotorServoStandard, openLoop)
#pragma config(Motor,  port7,           claw2,       tmotorServoStandard, openLoop)
...
task usercontrol()
{
	while (true){
		...
		digitalArmContol(armWrist, Btn5U, Btn5D, 80);//arm Wrist
		digitalServoControl(claw, Btn6U, btn6D);//claw
		digitalServoControl(claw2, Btn8L, btn8D); //claw arm
	}
}
