...
task main()
{
	...
	motor[FR] = -127;		  // Motor on port2 is run at full (-127) power reverse
	motor[BR]  = -127;		  // Motor on port3 is run at full (-127) power reverse
	motor[FL] = -127;		    // Motor on port4 is run at full (-127) power reverse
	motor[BL]  = -127;		    // Motor on port5 is run at full (-127) power reverse
	wait1MsecbackLeftMotor(3000);			              // Robot runs previous code for 3000 milliseconds before moving on
